	   ...
	   <s.Container jc={"center"} ai={"center"} style={{ width: "90%" }}>
		 ...
		 <div id="about" className="textBlock row">
          ...
          <div className="textBlockColumn">
            <s.TextTitle>
              ...
              Cool Simpson Football Club starts with a collection of 2022 unique NFTs. This collection for Cool Simpson Football Club 2022 will collect 40 heroes from simpsons family and etc.
            </s.TextTitle>
          </div>
        </div>
        ...
        <div className="footer-container">
          ...
          <s.TextTitle className="px-2">
            Cool Simpson Football Club 2022
          </s.TextTitle>
        </div>  
