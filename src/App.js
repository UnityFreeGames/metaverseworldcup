		...
		<div id="faq" className="textBlock row">
          <div id="toadverseIntro" className="textBlockColumn">
            <div>
              ...
              <s.TextSubTitle>
               Lego Metaverse is a collection of 2022 NFTs on ERC-721A that aims to build a global community for worldwide connections in both digital space and real world.Lego Metaverse can come to connect, promote businesses, share ideas or experiences about art, cultures, and various other topics. Certainly, Lego Metaverse NFT will be a valuable access to explore your new journey and connections.
              </s.TextSubTitle>
            </div>
          </div>
		 ...
		 <div id="about" className="textBlock row">
          ...
          <div className="textBlockColumn">
            <s.TextTitle>
              <s.Texttype1>Exceptional NFT</s.Texttype1>
              Metaverse World Cup starts with a collection of 2022 unique NFTs. This collection for Lego FIFA World Cup 2022 will collect 40 heroes from cristiano ronaldo, Lionel Messi, Neymar and etc.
            </s.TextTitle>
          </div>
        </div>
        <div className="textBlock row">
          ...
          <div className="textBlockColumn" id="vibemap">
            <div id="nnn-collectiv-big">
              <img
                width="400"
                src={require("./assets/6.jpg").default}
                alt="Vibemap"
              />
            </div>
          ...
          <div id="teamMembers">
            <div className="teamMember">
              <img
                ...
                alt="bored ape"
              />
              <s.TextSubTitle id="nameTag">Lego ape</s.TextSubTitle>
            </div>
            <div className="teamMember">
              <img
                className="teamImg"
                ...
                alt="lazy lions"
              />
              <s.TextSubTitle id="nameTag">Lego lions</s.TextSubTitle>
            </div>
            <div className="teamMember">
              <img
                className="teamImg"
                ...
                alt="pudgy penguins"
              />
              <s.TextSubTitle id="nameTag">Lego penguins</s.TextSubTitle>
            </div>
            <div className="teamMember">
              <img
                className="teamImg"
                ...
                alt="Lego punks"
              />
              <s.TextSubTitle id="nameTag">Lego punks</s.TextSubTitle>
            </div>
          </div>
        </div>
